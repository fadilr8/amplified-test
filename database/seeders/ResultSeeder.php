    ...
    public function run()
    {
        $results = [
            [
                ...
                'result' => 'Berdasarkan hasil screening kesehatan mental, saat ini kondisimu tergolong stabil. Jaga terus kesehatan mental kamu ya. Untuk mempertahankan kondisi tersebut, kamu bisa baca artikel dan tips bunda di https://www.ibunda.id.'
            ],
            [
                'title' => 'Oh, Kamu Membutuhkan Sedikit Bantuan!',
                'result' => 'Berdasarkan hasil screening kesehatan mental, saat ini kondisimu tergolong kurang stabil. Kamu mungkin membutuhkan sedikit bantuan untuk melewati situasi ini. Coba ingat-ingat lagi, adakah hal yang membuat kamu merasa kurang nyaman atau mengganggumu dalam beberapa hari belakangan ini? Jangan ragu untuk bercerita mengenai hal tersebut pada teman, keluarga, atau orang yang kamu percaya ya. Kamu juga bisa cerita ke Bunda lewat LINE http://bit.ly/ibundaLINE. Selalu ingat, kamu tidak sendirian.'
            ],
            [
